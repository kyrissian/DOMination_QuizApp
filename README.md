...
A browser-based quiz game that tests your knowledge of JavaScript basics. Questions are randomized every time you play, and a countdown timer keeps things moving!
...
├── app.js        # Quiz logic, timer, and DOM interactions
└── README.md
```
